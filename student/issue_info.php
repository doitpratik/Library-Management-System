...
<!--_________________sidenav_______________-->
  ...
  <a href="books.php"><div class="h"> Books</div></a>
  <a href="request.php"><div class="h"> Book Request</div></a>
  <a href="issue_info.php"><div class="h"> Issue Information</div></a>
  <a href="expired.php"><div class="h">Expired List</div></a>
</div>

<div id="main">
  
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; <!-- open -->Issue Information</span>
    ...
    $c=0;
      ...
      if(isset($_SESSION['login_user']))
      {
        // $sql="SELECT student.username,roll,books.bid,name,authors,edition,issue,issue_book.return FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE issue_book.username ='$_SESSION[login_user]' and issue_book.approve !='' ORDER BY `issue_book`.`return` ASC";
         $sql="SELECT student.username,student.roll,books.bid,books.name,books.authors,books.edition,issue_book.issue,issue_book.return FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE issue_book.username ='$_SESSION[login_user]' and issue_book.approve !='' ORDER BY `issue_book`.`return` ASC";
