...
<div id="main">
  ...
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Expired/Returned List</span>
<BR>
  ...
  <div class="container">
    ...
    <?php
      ...
      <form method="post" action="">
          <button name="submit2" type="submit" class="btn btn-default" style="background-color: #06861a; color: yellow;float: left;width:40%" >RETURNED</button> 
                      &nbsp&nbsp
          <button name="submit3" type="submit" class="btn btn-default" style="background-color: red; color: yellow;float: right;width:40%">EXPIRED</button>
      </form>
      <br>
      </div>
