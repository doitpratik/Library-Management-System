...
<div id="main">
  ...
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;Book Request</span>
  <script>
	function openNav() {
...
<div class="container">
	<div class="srch">
		...
		<form method="post" action="" name="form1">
			...
			<button style="background-color: #0d1f06;color:white"class="btn btn-default" name="submit" type="submit">Proceed to approval</button><br>
		</form>

	</div><br><br>
	<h3 style="text-align: center;"><b>Book Requests of Students</b></h3>
