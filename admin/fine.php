...
<div id="main">
  ...
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; <!-- open -->Fines</span>
...
<div class="container">
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<input class="form-control" type="text" name="search" placeholder="Student username.." required="" style="width: 100%">
