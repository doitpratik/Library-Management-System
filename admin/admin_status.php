...
<!--_________________sidenav_______________-->
		...
		<div id="main">
			<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; <!-- open -->Approval of Admins</span>
			<script>
				function openNav() 
				{
	...
	<!--__________________________search bar________________________-->
		<div class="container">
			<!-- <h2 style="float: left;">Approval of Admins</h2> -->
			...
			<br>
			<h2>New Requests for Admin access</h2>
			<?php
			...
			if(isset($_POST['submit']))
			{
				...
				else
				{
					...
					<br>
					<form method="post" >
						<button type="submit" name="submit_2" style=" background-color: #dedede; color : red; font-weight: 700; font-size: 18px;width: 35%;float: right" class="btn btn-default">&nbsp Remove</button>
						<button type="submit"  name="submit_3" style="background-color: #dedede; color: green; font-weight: 700; font-size: 18px;width: 35%;float: left" class="btn btn-default">
						&nbsp Approve</button>
					</form>
					<?php
