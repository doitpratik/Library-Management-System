...
<div id="main">
  ...
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; <!-- open -->Expired/Returned Information</span>
...
<?php
      ...
      <form method="post" action="">
          ...
          <button name="submit2" type="submit" class="btn btn-default" style="background-color: #06861a; color: white;">RETURNED</button> 
                     
          <button name="submit3" type="submit" class="btn btn-default" style="background-color: red; color: white;">EXPIRED</button>
          <a href="expired.php"><button  type="submit" class="btn btn-default" style="color: white;background-color: black">ALL</button></a>
      </form>
      </div>

      <div class="srch" style="width: 70%;float: right" >
          <br>
          <form method="post" action="" name="form1">
            <input type="text" name="username" class="form-control" placeholder="Username" required="" style="color: black;"><br>
            <input type="text" name="bid" class="form-control" placeholder="BID" required="" style="color: black"><br>
            <button class="btn btn-default" name="submit" type="submit" style="background-color: 
            #058292"><strong>Submit (book returned by the student)</strong></button><br><br>
          </form>
      </div>
        <?php
