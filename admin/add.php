  ...
  <div id="main">
    ...
    <div class="container" style="text-align: center;">
      ...
      <form class="book" action="" method="post">
        ...
        <button class="btn btn-default" style="float:right;width:100px;background-color: #021d21;margin-top: 27px;color: white" type="submit" name="submit"><b>ADD</b></button></div>
