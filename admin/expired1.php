...
<div id="main">
  ...
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Expired List</span>
<BR>
      ...
      <form method="post" action="">
       ...
       <div class="srch" >
          ...
          <form method="post" action="" name="form1" >
            ...
            <button class="btn btn-default" name="submit" type="submit" ><b>Submit</b></button><br><br>
          </form>
        </div>
