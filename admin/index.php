          ...
          if(isset($_SESSION['login_user']))
          {
            ...
            <div class="w3-top" >
              ...
              <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
                ...
                <a href="fine.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Fines</a>
                <a href="" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"><span class="glyphicon glyphicon-user"></span><span class="badge bg-black"><? php echo %a[total];?></span></a>
